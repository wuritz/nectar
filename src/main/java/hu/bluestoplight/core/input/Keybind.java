package hu.bluestoplight.core.input;

import hu.bluestoplight.utils.misc.InputUtils;
import hu.bluestoplight.utils.misc.interfaces.ICopyable;
...
public class Keybind implements ISerializable<Keybind>, ICopyable<Keybind> {
    ...
    public String getKey() {
        return InputUtils.getKeyName(value);
    }
    ...
    public String toString() {
        ...
        if (!isKey) return InputUtils.getButtonName(value);
        if (modifiers == 0) return InputUtils.getKeyName(value);
        ...
        label.append(InputUtils.getKeyName(value));
