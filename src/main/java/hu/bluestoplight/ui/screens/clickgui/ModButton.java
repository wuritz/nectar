...
import hu.bluestoplight.modules.util.settings.*;
import hu.bluestoplight.ui.UIUtils;
import hu.bluestoplight.ui.screens.clickgui.settings.*;
import hu.bluestoplight.ui.screens.clickgui.settings.Component;
...
public class ModButton {
    ...
    public void render(DrawContext drawContext, int mouseX, int mouseY, float deltaTicks) {
        ...
        if (isHovered(mouseX, mouseY)) {
            ...
            for (Mod m : ModManager.get().getEnabled()) {
