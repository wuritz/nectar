...
package hu.bluestoplight.ui.waypoints;
...
public class WaypointManager {
    ...
    private String getCurrentWorldID() {
        if (SednaClient.mc.isInSingleplayer() && SednaClient.mc.getServer() != null) {
            return "singleplayer:" + SednaClient.mc.getServer().getSaveProperties().getLevelName();
        } else if (SednaClient.mc.getCurrentServerEntry() != null) {
            if (SednaClient.mc.getServer() == null) {
                return "realm:" + SednaClient.mc.getCurrentServerEntry().name;
            } else {
                return "multiplayer:" + SednaClient.mc.getCurrentServerEntry().address;
            }
        } else {
            return "global";
        }
    ...
    public void save() {
        try (Writer writer = new FileWriter(CONFIG_FILE)) {
            ...
            SednaClient.LOGGER.error("[SEDNA]: Error in Waypoint Manager! " + e.toString());
        }
    }
